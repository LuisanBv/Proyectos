...
<head>
    ...
    <title>ELIMINACION DE SUCURSALES</title>
...
<body>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>Eliminacion de sucursales</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--/ bradcam_area  -->
        ...
        <section id="insert"> 
        <div class="bradcam_text text-center">
            <h3>Ingrese el ID de la sucursal que desea eliminar</h3>
         </div>
         <style>
                .container1 {
                    display: flex;
        ...
        <form action="php/delsucursal.php" method="POST">
                <div class="container1">
                        ...
                        <label for="id">Ingrese el ID:</label>
                                ...
                                <?php
                                        ...
                                        $sql = "SELECT ID_almacen, estado, ciudad FROM almacen";
                                        $stmt = oci_parse($conexion, $sql);
                                        oci_execute($stmt);
                                        ...
                                        while ($row = oci_fetch_assoc($stmt)) {
                                            ...
                                            echo '<option value="' . $idalmacen . '">' . $idalmacen . ' ' . $estado . ' ' .$ciudad . ' ' .  '</option>';
                                        }
