...
<head>
    ...
    <title>ELIMINACIÓN DE ROLES</title>
...
<body>
    ...
    <!--/ bradcam_area  -->
        ...
        <section id="insert"> 
        <div class="bradcam_text text-center">
            <h3>Ingrese el ID del rol que se desea eliminar</h3>
         </div>
         <style>
                .container1 {
                    display: flex;
        ...
        <div class="container1">
                <div class="column">
            <form action="php/delrol.php" method="POST">
            ...
            <div class="custom-button-container">
                 <input type="submit" name="eliminar" value="Eliminar" class="custom-button">
            </div>
