...
<body>
    ...
    <!--/ bradcam_area  -->
        ...
        <section id="insert"> 
        <div class="bradcam_text text-center">
            <h3>Ingrese el ID del rol que se desea modificar</h3>
         </div>
         <style>
                .container1 {
                    display: flex;
        ...
        <div class="container1">
                <div class="column">
            <form action="php/actrol.php" method="POST">
            ...
            <div class="custom-button-container">
                 <input type="submit" name="insertar" value="Actualizar" class="custom-button">
            </div>
