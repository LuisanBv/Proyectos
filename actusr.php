...
<body>
    ...
    <!--/ bradcam_area  -->
			...
			<div class="row">
					<div class="col-lg-12">
                        ...
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<?php 
                                        $sql = "SELECT ID_usuario, correo, password, nombre, ap, am, id_rol FROM usuarios";
        ...
        <section id="insert"> 
        <div class="bradcam_text text-center">
            <h3>Actualizacion de un usuario</h3>
         </div>
         <style>
                .container1 {
                    display: flex;
        ...
        <div class="container1">
                <div class="column">
            <form action="php/actuausr.php" method="POST">
                        ...
                        <?php
                                        ...
                                        echo '<select name="id">';
                                        echo '<option value="" disabled selected>ID Usuario</option>'; // Opción deshabilitada
                                        ...
                                        while ($row = oci_fetch_assoc($stmt)) {
                                            ...
                                            echo '<option value="' . $idusuario . '">' . $idusuario . ' ' . $nombre . ' ' . $am . ' ' . $ap . ' ' .  '</option>';
                                        }
                        ...
                        <?php
                                        ...
                                        // Consulta de destinatarios
                                        $sql = "SELECT ID_rol, descripcion FROM roles";
                                        $stmt = oci_parse($conexion, $sql);
                                        oci_execute($stmt);

                                        // Generar el combo box
                                        echo '<select name="id_rol">';
                                        echo '<option value="" disabled selected>Roles</option>'; // Opción deshabilitada

                                        while ($row = oci_fetch_assoc($stmt)) {
                                            $idalmacen = $row['ID_ROL'];
