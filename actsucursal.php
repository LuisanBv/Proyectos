...
<head>
    ...
    <title>ACTUALIZACION DE SUCURSALES</title>
...
<body>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>Actualizacion de sucursales</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--/ bradcam_area  -->
        ...
        <section id="insert"> 
        <div class="bradcam_text text-center">
            <h3>Actualizacion de una sucursal</h3>
         </div>
         <style>
                .container1 {
                    display: flex;
        ...
        <div class="container1">
                <div class="column">
            <form action="php/actsucursal.php" method="POST">
                        <label for="id">Id de la sucursal:</label>
                        <br>
                        <?php
