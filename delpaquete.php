...
<head>
    ...
    <title>ELIMINACION DE PAQUETES</title>
...
<body>
    ...
    <!--/ bradcam_area  -->
        ...
        <section id="insert"> 
        <div class="bradcam_text text-center">
            <h3>Ingrese el ID del paquete que desea eliminar</h3>
         </div>
         <style>
                .container1 {
                    display: flex;
        ...
        <form action="php/delpaquete.php" method="POST">
                        ...
                        <label for="id">Ingrese el ID:</label>
                                ...
                                <?php
                                        ...
                                        while ($row = oci_fetch_assoc($stmt)) {
                                            ...
                                            echo '<option value="' . $idp . '">' . $idp . ' ' . $descri .   '</option>';
                                        }
            ...
            <div class="custom-button-container">
                 <input type="submit" name="actualizar" value="Eliminar" class="custom-button">
            </div>
